...
export function AddLibraryNodePanel({
  ...
  const initialParentFolderId = panel.parentFolderId;
  ...
  const initialSuggestedTemplate = null;
  const initialFileTypes = getInheritedSuggestionFileTypes(initialParentTemplate);
